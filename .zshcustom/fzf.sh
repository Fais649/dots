...
zle     -N            ff
bindkey -M emacs '^_' ff
bindkey -M vicmd '^_' ff
bindkey -M viins '^_' ff
...
zle     -N            cd_fzf
bindkey -M emacs '^F' cd_fzf
bindkey -M vicmd '^F' cd_fzf
bindkey -M viins '^F' cd_fzf
